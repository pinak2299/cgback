...
result = subprocess.run('cgback frames/frame0_proc.pdb -o outputs/out0_proc.pdb -d cuda --fix-structure-max-iterations 200', shell=True, capture_output=True, text=True)
...
max_workers = multiprocessing.cpu_count()  # Adjust based on your GPU capacity
# max_workers = 32
...
for batch in range(total_batches):
    ...
    if batch == 0:
        ...
        prev_batch_file = f'rebuilt_segment_04_{prev_start}_{prev_end}.dcd'
    ...
    batch_filename = f'rebuilt_segment_04_{start_frame}_{end_frame}.dcd'
...
# Final trajectory will be saved as rebuilt_segment_04.dcd by the user if needed
